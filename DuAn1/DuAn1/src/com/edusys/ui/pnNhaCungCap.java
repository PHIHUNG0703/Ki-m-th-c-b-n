...
public class pnNhaCungCap extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnSapXep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icons/icons8-down-button-24.png"))); // NOI18N
        ...
        tblNhaCungCap.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
    ...
    private void btnThemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMouseClicked
        try (DataInputStream dis = new DataInputStream(new FileInputStream("src\\MaTuSinh\\MANCCTS.dat"))) {
            ...
            MaNCCTS += 1;
            if (MaNCCTS >= 10) {
                txtMaNCC.setText(String.valueOf("kh" + MaNCCTS));
            } else if (MaNCCTS < 10) {
                txtMaNCC.setText(String.valueOf("kh0" + MaNCCTS));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
