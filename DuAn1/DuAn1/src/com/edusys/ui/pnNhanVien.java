...
public class pnNhanVien extends javax.swing.JPanel {
    ...
    boolean batLoi() {
        ...
        if (!txtMatKhau.getText().matches(matKhau)) {
            JOptionPane.showMessageDialog(this, "Mật khẩu không được bỏ ký tự đặt biệt vào và phải có đủ 8 ký tự");
            return false;
        }
        ...
        String soDienThoai = "^[0-9]{10}+$";
        if (!txtSoDienThoai.getText().matches(soDienThoai)) {
            JOptionPane.showMessageDialog(this, "Số điên thoại chỉ được nhập số và chỉ nhập 10 số");
            return false;
        }
    ...
    private void initComponents() {
        ...
        pnInfoNv.add(txtMaNV, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 50, 500, 40));
        ...
        pnInfoNv.add(txtSoDienThoai, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 130, 240, 40));
        ...
        pnInfoNv.add(btnFirst, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 350, 80, 30));
        ...
        pnInfoNv.add(btnPrev, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 350, 80, 30));
        ...
        pnInfoNv.add(btnNext, new org.netbeans.lib.awtextra.AbsoluteConstraints(1270, 350, 80, 30));
        ...
        pnInfoNv.add(btnLast, new org.netbeans.lib.awtextra.AbsoluteConstraints(1390, 350, 80, 30));
    ...
    private void btnThemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMouseClicked
        if (batLoi() == true) {
            try (DataInputStream dis = new DataInputStream(new FileInputStream("src\\MaTuSinh\\MANVTS.dat"))) {
                ...
                MaNVTS += 1;
                if (MaNVTS >= 10) {
                    txtMaNV.setText(String.valueOf("nv" + MaNVTS));
                } else if (MaNVTS < 10) {
