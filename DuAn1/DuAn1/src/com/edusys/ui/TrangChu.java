...
public class TrangChu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblMoMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icons/icons8-down-button-24.png"))); // NOI18N
    ...
    private void lblMoMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMoMenuMouseClicked
        if (moMenu == true) {
            openMenu();
            lblMoMenu.setIcon(new ImageIcon("src\\com\\edusys\\icons\\icons8-len24trang.png"));
            moMenu = false;
        } else if (moMenu == false) {
            lblMoMenu.setIcon(new ImageIcon("src\\com\\edusys\\icons\\icons8-xuong24trang.png"));
            closeMenu();
            moMenu = true;
        }
