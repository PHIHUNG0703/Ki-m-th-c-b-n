...
public class NhaCungCapDAO extends EduSysDAO<NhaCungCap, String> {
    ...
    final String SELECT_BY_KEY_WORD_SQL = "SELECT * FROM NHACUNGCAP WHERE TENNCC LIKE ?";
    final String SX_THEO_TEN = "SELECT * FROM NHACUNGCAP ORDER BY TENNCC ASC";
    final String SX_THEO_TEN_GIAMDAN = "SELECT * FROM NHACUNGCAP ORDER BY TENNCC DESC";
