...
public class pnKhachHang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnInfoNv1.setLayout(null);

        jLabel15.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel15.setText("Mã khách hàng");
        pnInfoNv1.add(jLabel15);
        jLabel15.setBounds(80, 50, 101, 20);
        pnInfoNv1.add(txtSdt);
        txtSdt.setBounds(80, 160, 500, 40);

        jLabel16.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel16.setText("Tên khách hàng");
        pnInfoNv1.add(jLabel16);
        jLabel16.setBounds(970, 50, 104, 20);
        pnInfoNv1.add(txtTenKH);
        txtTenKH.setBounds(970, 70, 500, 40);

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel17.setText("Số điện thoại");
        pnInfoNv1.add(jLabel17);
        jLabel17.setBounds(80, 140, 88, 20);

        jLabel18.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel18.setText("Địa chỉ");
        pnInfoNv1.add(jLabel18);
        jLabel18.setBounds(970, 140, 45, 20);
        pnInfoNv1.add(txtDiaChi);
        txtDiaChi.setBounds(970, 160, 500, 40);

        jLabel20.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel20.setText("Ghi Chú");
        pnInfoNv1.add(jLabel20);
        jLabel20.setBounds(80, 230, 51, 20);
        ...
        pnInfoNv1.add(btnSapXep);
        btnSapXep.setBounds(600, 350, 100, 30);
        ...
        pnInfoNv1.add(btnLast);
        btnLast.setBounds(1390, 350, 80, 30);

        txtMaKH.setEnabled(false);
        pnInfoNv1.add(txtMaKH);
        txtMaKH.setBounds(80, 70, 500, 40);

        txtGhiChu.setColumns(20);
        txtGhiChu.setRows(5);
        jScrollPane1.setViewportView(txtGhiChu);

        pnInfoNv1.add(jScrollPane1);
        jScrollPane1.setBounds(80, 250, 500, 86);

        add(pnInfoNv1);
        pnInfoNv1.setBounds(30, 30, 1550, 410);
        ...
        jScrollPane2.setBounds(30, 40, 1500, 400);

        add(jPanel4);
        jPanel4.setBounds(30, 510, 1560, 470);
