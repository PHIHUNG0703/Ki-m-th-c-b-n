...
public class PhieuNhapDAO extends EduSysDAO<PhieuNhap, String> {
    ...
    final String SELECT_ALL_SQL = "SELECT A.MAPNCT, B.MAPN, B.NGAYNHAP, B.MANCC, C.TENNCC, B.MANV, D.TENNV, A.MASP, E.TENSP, A.MALOAI, F.TENLOAI, DONGIANHAP,A.SOLUONG,A.DVTINH,A.THANHTIEN\n"
            + "FROM PHIEUNHAPCT A\n"
    ...
    final String SELECT_BY_ID_SQL = "SELECT A.MAPNCT, B.MAPN, B.NGAYNHAP, B.MANCC, C.TENNCC, B.MANV, D.TENNV, A.MASP, E.TENSP, A.MALOAI, F.TENLOAI, DONGIANHAP,A.SOLUONG,A.DVTINH,A.THANHTIEN\n"
            + "FROM PHIEUNHAPCT A\n"
            + "INNER JOIN PHIEUNHAP B ON A.MAPN = B.MAPN\n"
            + "INNER JOIN NHACUNGCAP C ON B.MANCC = C.MANCC\n"
            + "INNER JOIN NHANVIEN D ON B.MANV = D.MANV\n"
    ...
    final String SELECT_BY_KEY_WORD_SQL = "SELECT A.MAPNCT, B.MAPN, B.NGAYNHAP, B.MANCC, C.TENNCC, B.MANV, D.TENNV, A.MASP, E.TENSP, A.MALOAI, F.TENLOAI, DONGIANHAP,A.SOLUONG,A.DVTINH,A.THANHTIEN\n"
            + "FROM PHIEUNHAPCT A\n"
            + "INNER JOIN PHIEUNHAP B ON A.MAPN = B.MAPN\n"
            + "INNER JOIN NHACUNGCAP C ON B.MANCC = C.MANCC\n"
            + "INNER JOIN NHANVIEN D ON B.MANV = D.MANV\n"
