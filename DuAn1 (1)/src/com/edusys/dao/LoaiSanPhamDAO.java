...
public class LoaiSanPhamDAO extends EduSysDAO<LoaiSanPham, String> {
    ...
    final String SELECT_BY_KEY_WORD_SQL = "SELECT * FROM LOAISANPHAM WHERE TENLOAI LIKE ?";
    final String SX_THEO_TEN_TANG_DAN = "SELECT * FROM LOAISANPHAM ORDER BY TENLOAI ASC";
    final String SX_THEO_TEN_GIAM_DAN = "SELECT * FROM LOAISANPHAM ORDER BY TENLOAI DESC";
    ...
    public List<LoaiSanPham> sapxeptangdan() {
        return selectBySql(SX_THEO_TEN_TANG_DAN);
    }

    public List<LoaiSanPham> sapxepgiamdan() {
