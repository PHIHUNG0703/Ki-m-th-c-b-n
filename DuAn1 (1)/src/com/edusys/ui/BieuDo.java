 ...
 * @author ACER
 */
public class BieuDo extends javax.swing.JDialog {

    /**
     * Creates new form BieuDo
     */
    public BieuDo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        PieChartExample3d();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BieuDo dialog = new BieuDo(new javax.swing.JFrame(), true);
